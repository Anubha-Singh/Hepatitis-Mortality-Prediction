...
def main():
    ...
    st.title("Disease Mortality Prediction")
    ...
    if choice == "Home":
        ...
        st.image(load_image('images/hepimage.jpg'))
        ...
        if st.sidebar.checkbox("Login"):
            ...
            if result:
                ...
                if activity == "Plot":
                    ...
                    single_Sample = np.array(feature_list).reshape(-1,1).astype('int')

					# ML
                    model_choice = st.selectbox("Select Model",["LR"])
                    ...
                    if st.checkbox("Interpret"):
                        if model_choice == "KNN":
                            ...
                            exp = explainer.explain_instance(np.array(feature_list), loaded_model.predict_proba,num_features=13, top_labels=2)
